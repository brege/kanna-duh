...
const SAMPLE_RELEASES = [
  {
    ...
    name: "v0.8.1",
    tag_name: "v0.8.1",
    html_url: "https://github.com/brege/kanna-duh/releases/tag/v0.8.1",
  ...
  },
  {
    ...
    html_url: "https://github.com/brege/kanna-duh/releases/tag/v0.9.0-beta.1",
...
describe("fetchGithubReleases", () => {
  test("filters draft releases and sends the GitHub accept header", async () => {
    ...
    expect(requestedUrl).toBe("https://api.github.com/repos/brege/kanna-duh/releases")
...
describe("ChangelogSection", () => {
  test("renders version highlights, release cards, markdown, links, and prerelease badges", () => {
    ...
    expect(html).toContain("https://github.com/brege/kanna-duh/releases/tag/v0.8.1")
